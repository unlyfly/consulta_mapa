...
function customConverter(columns, f) {
  ...
  return function (row, i) {
    return f ? customConverter(row, f) : objectConverter(row);
  };
}
...
// Export the necessary functions to the global scope if needed
window.csvParse = csvParse;
window.csvParseRows = csvParseRows;
window.csvFormat = csvFormat;
window.csvFormatRows = csvFormatRows;
