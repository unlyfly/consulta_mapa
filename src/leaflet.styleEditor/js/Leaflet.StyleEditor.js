var leafletstyleeditor = /******/ (function (modules) {
  // webpackBootstrap
  /******/ // The module cache
  ...
  /******/ [
    ...
    /***/ function (module, __webpack_exports__, __webpack_require__) {
      ...
      var external_commonjs_leaflet_amd_leaflet_root_L_ =
      ...
      function setupColorElement() {
        L.StyleEditor.formElements.ColorElement =
          L.StyleEditor.formElements.FormElement.extend({
              ...
              if (!this.options.colorRamp) {
                ...
                if (
                  ...
                  this.options.colorRamp =
                    this.options.styleEditorOptions.markerType.options.colorRamp; // else use the default
                } else {
                  this.options.colorRamp =
                    this.options.styleEditorOptions.colorRamp;
                }
              }
      ...
      function setupFormElement() {
        L.StyleEditor.formElements.FormElement = L.Class.extend({
          ...
          setStyle: function setStyle(value) {
            var currentElement =
              this.options.styleEditorOptions.util.getCurrentElement(); // check whether a layer is part of a layerGroup
      ...
      function setupIconElement() {
        L.StyleEditor.formElements.IconElement =
          L.StyleEditor.formElements.FormElement.extend({
            ...
            createContent: function createContent() {
              var uiElement = this.options.uiElement;
              var selectBox = L.DomUtil.create(
                "div",
                "leaflet-styleeditor-select",
                uiElement
              );
              this.options.selectBoxImage =
                this._createSelectInputImage(selectBox);
              L.DomEvent.addListener(
                selectBox,
                "click",
            ...
            style: function style() {
              var iconOptions =
                this.options.styleEditorOptions.markerType.getIconOptions();
            ...
            _createSelectInputImage: function _createSelectInputImage(
              parentUiElement
            ) {
              var wrapper = L.DomUtil.create(
                "div",
            ...
            _styleSelectInputImage: function _styleSelectInputImage(
              image,
              icon,
              color
            ) {
            ...
            _createColorSelect: function _createColorSelect(color) {
              ...
              var uiElement = this.options.uiElement;
              var selectOptionWrapper = L.DomUtil.create(
                "ul",
                this._selectOptionWrapperClasses,
                uiElement
              );
              this.options.styleEditorOptions.util
                .getMarkersForColor(color)
                .forEach(function (option) {
                  var selectOption = L.DomUtil.create(
                    "li",
                    this._selectOptionClasses,
                    selectOptionWrapper
                  );
              ...
              L.DomEvent.addListener(
                ...
                function (e) {
                  ...
                  if (
                    ...
                    while (
                      target &&
                      target.className !== "leaflet-styleeditor-select-image"
                    ) {
            ...
            _hideSelectOptions: function _hideSelectOptions() {
              for (var selectOption in this.options.selectOptions) {
                this.options.styleEditorOptions.util.hideElement(
                  this.options.selectOptions[selectOption]
                );
              }
            },
          });
      ...
      function setupOpacityElement() {
        L.StyleEditor.formElements.OpacityElement =
          L.StyleEditor.formElements.FormElement.extend({
            /** create number input box */
            createContent: function createContent() {
              this.options.label = L.DomUtil.create(
                "span",
                "leaflet-styleeditor-input-span",
                this.options.uiElement
              );
              var slider = (this.options.slider = L.DomUtil.create(
                "input",
            ...
            style: function style() {
              this.options.slider.value =
                this.options.styleEditorOptions.util.getStyle(
                  this.options.styleOption
                );
              this.options.label.innerText =
      ...
      function setupPopupContentElement() {
        L.StyleEditor.formElements.PopupContentElement =
          L.StyleEditor.formElements.FormElement.extend({
            options: {
              title: "Description",
            },
            createContent: function createContent() {
              var uiElement = this.options.uiElement;
              var textArea = (this.options.descTextAreaField = L.DomUtil.create(
                "textarea",
                "leaflet-styleeditor-input",
                uiElement
              ));
            ...
            style: function style() {
              var selectedElement =
                this.options.styleEditorOptions.util.getCurrentElement();

              if (selectedElement && selectedElement.options) {
                this.options.descTextAreaField.value =
                  selectedElement.options.popupContent || "";
              }
            },
      ...
      function setupSizeElement() {
        L.StyleEditor.formElements.SizeElement =
          L.StyleEditor.formElements.FormElement.extend({
            ...
            createContent: function createContent() {
              ...
              L.DomEvent.addListener(
                ...
                function () {
                  this.setStyle(
                    this.options.styleEditorOptions.markerType.options.size
                      .small
                  );
                },
                this
              );
              select = L.DomUtil.create(
                "div",
      ...
      function setupWeightElement() {
        L.StyleEditor.formElements.WeightElement =
          L.StyleEditor.formElements.FormElement.extend({
            /** create number input box */
            createContent: function createContent() {
              this.options.label = L.DomUtil.create(
              ...
              var weight = (this.options.weight = L.DomUtil.create(
                "input",
                "leaflet-styleeditor-input",
                this.options.uiElement
              ));
        ...
        L.StyleEditor.forms.Form = L.Class.extend({
          ...
          create: function create(parentUiElement) {
            ...
            for (var i = 0; i < styleFormKeys.length; i++) {
              var formElement = this.getFormElementClass(
                styleFormKeys[i],
                formElements
              );
          ...
          showFormElement: function showFormElement(formElement) {
            ...
            if (
              this.showFormElementForStyleOption(
                formElement.options.styleOption
              )
            ) {
              formElement.show();
            } else {
          ...
          getFormElements: function getFormElements() {
            ...
            if (
              this.options.formOptionKey in
              this.options.styleEditorOptions.forms
            ) {
              formElements =
                this.options.styleEditorOptions.forms[
                  this.options.formOptionKey
                ];
            } else {
            ...
            if (formElementKeys.indexOf(styleOption) >= 0) {
              ...
              if (FormElement) {
                ...
                try {
                  ...
                  if (
                    formElementInstance instanceof
                    L.StyleEditor.formElements.FormElement
                  ) {
           ...
           */
          showFormElementForStyleOption: function showFormElementForStyleOption(
            styleOption
          ) {
            var formElements = this.getFormElements();
           ...
           */
          getFormElementStandardClass: function getFormElementStandardClass(
            styleOption
          ) {
      ...
      function setupGeometryForm() {
        L.StyleEditor.forms.GeometryForm = L.StyleEditor.forms.Form.extend({
          ...
          showFormElements: function showFormElements() {
            for (var i = 0; i < this.options.initializedElements.length; i++) {
              if (
                this.options.initializedElements[i].options.styleOption.indexOf(
                  "fill"
                ) === 0
              ) {
      ...
      function setupMarker() {
        L.StyleEditor.marker.Marker = L.Marker.extend({
          ...
          /** create HTML used to */
          createSelectHTML: function createSelectHTML(
            parentUiElement,
            iconOptions,
            icon
          ) {},
          ...
          getIconOptions: function getIconOptions() {
            try {
              this.options.iconOptions =
                this.options.styleEditorOptions.currentElement.target.options.icon.options;
            } catch (e) {
            ...
            this.options.iconOptions.iconSize =
              this.options.styleEditorOptions.markerType.options.size.small;
            this.options.iconOptions.icon =
              this.options.styleEditorOptions.util.getDefaultMarkerForColor(
                this.options.iconOptions.iconColor
              );
            this.options.iconOptions = this._ensureMarkerIcon(
              this.options.iconOptions
            );
            return this.options.iconOptions;
          },
          ...
          _ensureMarkerIcon: function _ensureMarkerIcon(iconOptions) {
            var markers =
              this.options.styleEditorOptions.util.getMarkersForColor(
                iconOptions.iconColor
              );
        ...
        L.StyleEditor.marker.DefaultMarker = L.StyleEditor.marker.Marker.extend(
          {
            ...
            _getMarkerUrl: function _getMarkerUrl(size, color, icon) {
              ...
              if (color.indexOf("#") === 0) {
                ...
                color = this.options.styleEditorOptions.util.rgbToHex(
                  color,
                  true
                );
              }
      ...
      function setupGlyphiconMarker() {
        L.StyleEditor.marker.GlyphiconMarker =
          L.StyleEditor.marker.Marker.extend({
            ...
            createSelectHTML: function createSelectHTML(
              ...
              parentUiElement.innerHTML = this.getMarkerHtml(
                "s",
                iconOptions.iconColor,
                icon
              );
        ...
        L.StyleForm = L.Class.extend({
          ...
          lostFocus: function lostFocus(e) {
            ...
            for (var i = 0; i < 10; i++) {
              ...
              if (
                !!parent.className &&
                L.DomUtil.hasClass(parent, "leaflet-styleeditor-interior")
              ) {
                return;
              }
      ...
      function setupControl() {
        L.Control.StyleEditor = L.Control.extend({
          ...
          initialize: function initialize(options) {
            ...
            this.getDefaultIcon =
              this.options.markerType._createMarkerIcon.bind(
                this.options.markerType
              );
            this.createIcon = this.options.markerType.createMarkerIcon.bind(
              this.options.markerType
            );
          },
          ...
          createUi: function createUi() {
            var controlDiv = (this.options.controlDiv = L.DomUtil.create(
              "div",
              "leaflet-control-styleeditor leaflet-control leaflet-bar"
            ));
            var controlUI = (this.options.controlUI = L.DomUtil.create(
              "a",
              "leaflet-control-styleeditor-interior",
              controlDiv
            ));
            controlUI.title = "Style Editor";
            var cancel = (this.options.cancelUI = L.DomUtil.create(
              "div",
            ...
            var styleEditorInterior = L.DomUtil.create(
              "div",
          ...
          disable: function disable() {
            if (this.isEnabled()) {
              this.options._editLayers.forEach(
                this.removeEditClickEvents,
                this
              );
          ...
          hideEditor: function hideEditor() {
            if (
              L.DomUtil.hasClass(this.options.styleEditorDiv, "editor-enabled")
            ) {
              this.removeIndicators();
              L.DomUtil.removeClass(
                this.options.styleEditorDiv,
        ...
        L.StyleEditor.Util = L.Class.extend({
          ...
          fireEvent: function fireEvent(eventName, element) {
            this.options.styleEditorOptions.map.fireEvent(
              this.options.styleEditorOptions.styleEditorEventPrefix +
                eventName,
              element
            );
          },
          ...
          rgbToHex: function rgbToHex(rgb, noHash) {
            ...
            var withoutHash =
              this._componentToHex(parseInt(rgbArray[0], 10)) +
              this._componentToHex(parseInt(rgbArray[1], 10)) +
          ...
          getMarkersForColor: function getMarkersForColor(color) {
            ...
            var markers =
              this.options.styleEditorOptions.markerType.options.markers;
          ...
          getDefaultMarkerForColor: function getDefaultMarkerForColor(color) {
            ...
            var defMarkers = [];
            var defaultMarker =
              this.options.styleEditorOptions.defaultMarkerIcon;
            ...
            defaultMarker =
              this.options.styleEditorOptions.markerType.options
                .defaultMarkerIcon;
      ...
      setupStyleForm();
      setupControl();
      /* harmony default export */ var Leaflet_StyleEditor =
