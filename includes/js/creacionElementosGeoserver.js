async function createWorkspaceDatastoreLayer(geoserverUrl, workspaceName, datastoreName, layerName) {
  ...
  try {
    ...
    if (layerResponse.status === 404) {
      ...
      await fetch(`${geoserverUrl}/workspaces/${workspaceName}/datastores/${datastoreName}/featuretypes`, {
          method: "POST",
          headers,
...
const workspaceName = "cluster";
const datastoreName = "dspm_alumbrado";
const layerName = "luminarias_geom";

createWorkspaceDatastoreLayer(geoserverUrl, workspaceName, datastoreName, layerName);
